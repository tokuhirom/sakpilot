...
// under a temp HOME, mirroring how serviceendpointgateway.NewService(profileName, zone)
// resolves credentials in production. Returns the profile name to pass to NewService.
